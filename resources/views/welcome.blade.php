                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{$Produc->product_image}}" alt=""  height="250px" width="150px"/>
                                            <h2>${{$Produc->product_price}}</h2>
                                            <p>{{$Produc->product_name}}</p>
                                            <a href="{{route('view_product_detail',$Produc->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2>${{$Produc->product_price}}</h2>
                                                <a href="{{route('view_product_detail',$Produc->product_id)}}"><p>{{$Produc->product_name}}</p></a>
                                                <a href="{{route('view_product_detail',$Produc->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            ...
                                            <li><a href="{{route('view_product_detail',$Produc->product_id)}}"><i class="fa fa-plus-square"></i>view product</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
